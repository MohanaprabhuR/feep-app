            ...
            personalFactors: {
              health: {
                ...
                factors: [
                  ...
                  { name: "Routine checkups", status: "not_covered", risk: "medium" },
              ...
              life: {
                ...
                factors: [
                  ...
                  { name: "Drug/Alcohol", status: "not_covered", risk: "medium" },
                  { name: "Policy lapsed", status: "not_covered", risk: "medium" },
                ],
            ...
            assetFactors: {
              home: {
                ...
                factors: [
                  ...
                  { name: "Illegal extension", status: "not_covered", risk: "medium" },
                ],
              ...
              auto: {
                ...
                factors: [
                  ...
                  { name: "Drunk driving", status: "not_covered", risk: "high" },
                  { name: "Wear & Tear", status: "not_covered", risk: "medium" },
                ],
          ...
          response: [
            {
              ...
              description: "Get customized auto insurance with 20% yearly savings",
            },
            {
              ...
              priceType: "MONTHLY",
              offerEnds: "2025-11-10",
              description: "Comprehensive health coverage with significant savings",
            },
          ],
        },
        getQuote: {
